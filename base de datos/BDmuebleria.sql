...
-- Dumping data for table bd_luhi_muebleria.articulos: ~4 rows (approximately)
...
INSERT INTO `articulos` (`NoSerie`, `Precio`, `Material`, `TipoMueble`, `Marca`, `Color`) VALUES
	...
	(4, 67, 'Abedul', 'LITERA', 'MATTEOGRASSI', 'Cafe'),
	(5, 90, 'Roble oscuro', 'ESCRITORIO', 'TREKU', 'Rojizo'),
	(6, 100, 'Roble', 'OTOMAN', 'GALA', 'Crema');
